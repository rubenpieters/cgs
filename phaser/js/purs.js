...
(function(exports) {
  ...
  var nextDragMode = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 30, column 1 - line 30, column 37: " + [ v.constructor.name ]);
  };
  ...
  var updateCardSelectMenu = function __do() {
      ...
      throw new Error("Failed pattern match at Main line 49, column 3 - line 51, column 32: " + [ v1.constructor.name ]);
  };
  var selectCard = function (cid) {
      return function __do() {
          ...
          (function () {
              if (v1 instanceof Data_Maybe.Just) {
                  return $foreign.toggleSelected(v1.value0);
              };
              if (v1 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
              };
              throw new Error("Failed pattern match at Main line 103, column 3 - line 105, column 25: " + [ v1.constructor.name ]);
          })()();
  ...
  var updateGameState = function (es) {
      ...
      var go = function (v) {
          ...
          throw new Error("Failed pattern match at Main line 94, column 5 - line 94, column 50: " + [ v.constructor.name ]);
      };
      var arrayToList = Data_List.fromFoldable(Data_Foldable.foldableArray);
      return go(arrayToList(es));
  };
  ...
  var ordDragMode = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Main line 28, column 8 - line 28, column 44: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var emptyGS = {
  ...
  var addCard = function (c) {
      return function (gs) {
          ...
          var $36 = {};
          for (var $37 in gs) {
              if ({}.hasOwnProperty.call(gs, $37)) {
                  $36[$37] = gs[$37];
              };
          };
          $36.cards = Data_Map.insert(Data_Ord.ordInt)(cid)(c)(gs.cards);
          return $36;
      };
  };
